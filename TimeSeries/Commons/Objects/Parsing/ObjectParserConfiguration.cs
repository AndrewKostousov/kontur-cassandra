...
using SKBKontur.Catalogue.Objects.Parsing.Exceptions;
using SKBKontur.Catalogue.Objects.Parsing.ParseHelpers;
using SKBKontur.Catalogue.Objects.Parsing.Parsers;
using SKBKontur.Catalogue.Objects.Parsing.Parsers.InternalImplementations;

namespace SKBKontur.Catalogue.Objects.Parsing
{
    public class ObjectParserConfiguration : IObjectParserCollection
    {
